...
public class MatchesServiceTest 
{
    ...
    @Test
    public void TestAddMatch() throws MatchAlreadyFoundException 
    {
        Matches m1=new Matches(10,"India","Srilanka"); // user input
        when(matchRepo.save(any())).thenReturn(m1); //save any object to repository
        msl.addMatch(m1); //data saved in database
        verify(matchRepo,times(1)).save(any()); //calling any method once
    }
